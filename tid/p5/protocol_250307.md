...
拿音频和视频进行比较，数字音频的核心有采样率和量化深度两个基础概念

* 采样率: 从8k\~256k，各有不同的应用场景。音乐领域常用44.1k，低于此多用在对讲场景，高于此的通常是高保真音频。
* 音频帧: 由于采样率的范围极大，音频帧的范围也更弹性，不像视频有比较公认的25~30的帧率
* 量化深度: 类似视频分辨率
* 频响范围: 对应显示器的色域

音频最低的采样率是8k，因为人声的频响范围在100\~3400Hz，根据奈奎斯特定理采样率至少是原频率的2倍，所以定在8K。采样率高导致处理音频时把多个采样点合并在一起作为一帧。人声的最低频响是100Hz，一个音频帧要至少容纳2个周期，所以音频帧通常在20\~50帧/秒，MP3把1152个采样合成一帧，大约38帧/秒。FLAC/APE/AAC的采样帧在1024\~4608之间。
